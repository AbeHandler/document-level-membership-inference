...
do
    CUDA_VISIBLE_DEVICES=0 python src/compute_perplexity.py --data_dir='./data' \
                    --path_to_tokenizer='./pretrained/tokenizers/open_llama_3b' --path_to_model='./pretrained/models/open_llama_3b' \
                    --path_to_dataset="./data/final_chunks/gutenberg_${chunk}_min_tokens100_seed42" \
